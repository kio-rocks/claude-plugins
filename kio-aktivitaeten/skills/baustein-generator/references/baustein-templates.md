...
## IT-Prüfhinweis (PFLICHT — statischer Bestandteil jedes Baustein-Outputs)

Jeder Baustein-Output MUSS am Ende folgenden Hinweis-Block enthalten — unabhängig vom Delivery-Format. Dieser Block ist statischer Template-Text und darf nicht weggelassen, verkürzt oder umformuliert werden:
...
- [ ] IT-Prüfhinweis am Ende (siehe oben — PFLICHT)
