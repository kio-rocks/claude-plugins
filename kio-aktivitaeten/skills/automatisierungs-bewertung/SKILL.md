...
- **Manuell in Workspace:** 1-2h (Einrichtung)
- **Apps Script:** 4-8h (Code + Test)
- **Artifact:** 2-4h (Design + Daten)
- **Claude Skill:** 1-3h (SKILL.md)
