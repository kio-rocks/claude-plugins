...
description: Beschreibt einen Prozess strukturiert durch geführte Fragen zu Trigger, Schritten, Systemen, Dauer und Output. Wird ausgelöst durch "Beschreibe Prozess [Name]", "Wie läuft [Aktivität] ab?" oder "/vorschlaege" mit Prozess-Kontext. Erstellt strukturierte Prozessbeschreibungen aus dem Dialog.
---
